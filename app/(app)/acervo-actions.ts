...
/**
 * Registra uso (abriu módulo, viu bloqueado, viu a calculadora, clicou na Biblioteca). Nunca atrapalha a
 * navegação: se falhar, a cliente não pode ficar sem o módulo por causa disso.
 */
export async function registrarEvento(tipo: TipoEvento, ref = "") {
  try {
