...
export function CalculoSalvoDetalhe({ id }: { id: string }) {
  ...
  const voltar = (
    <Link
      href="/historico"
      className="-ml-2 mb-2 inline-flex h-11 items-center gap-1 pr-3 text-sm font-semibold text-tinta/70"
    >
    ...
    <div>
      ...
      {resultado.ok ? (
        ...
        <section>
          ...
          <p className="mt-4 rounded-xl bg-ouro-claro px-4 py-3">{resultado.erro}</p>
  ...
  return (
    <>
      <Link
        ...
        className="flex h-14 items-center justify-center gap-2 rounded-xl bg-azul text-base font-semibold text-white active:bg-azul-escuro"
      >
  ...
  return (
    <>
      <button
        ...
        className="flex h-12 items-center justify-center gap-2 rounded-xl border border-linha bg-white font-semibold text-tinta/80"
      >
      ...
      >
        <div className="pb-seguro p-5">
          ...
          <p className="mt-2 text-tinta/70">Ele sai do seu histórico e não dá para recuperar.</p>
          <div className="mt-5 grid gap-2">
            <button
              ...
              className="h-14 rounded-xl bg-tinta text-base font-semibold text-white"
            >
              Sim, excluir
            </button>
            <button
